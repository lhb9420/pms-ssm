...
<div class="x-nav">
    ...
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${ctx }/job/list"
       title="刷新">
...
<div class="x-body">
    <div class="layui-row" style="" align="center">
        <form class="layui-form layui-col-md12 x-so" method="get" action="${ctx }/job/list">
            <input type="text" name="content" style="width:50%;" placeholder="请输入查找职位名称" autocomplete="off"
                   class="layui-input">
            ...
            <tr>
                ...
                <c:choose>
                    <c:when test="${sessionScope.tip  == 3 }">
                        <td class="td-manage">
                            <a title="编辑" href="${ctx}/job/add?id=${notice.id }">
