...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="./index2.html">人事管理系统</a></div>
    <div class="left_open">
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='${ctx}/welcome2' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
        </div>
    </div>
</div>
