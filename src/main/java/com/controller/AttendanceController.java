...
public class AttendanceController {
    ...
    @RequestMapping(value = "/attendance/list1", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/attendance/list2", method = RequestMethod.GET)
    ...
    @RequestMapping("/attendance/table1")
    @ResponseBody
    public Page<Attendance> attendance_table1(HttpSession session, int page, int limit, String day) {
        User user = (User) session.getAttribute(Constants.USER_SESSION);
        String name = user.getUsername();
        Page<Attendance> date = rainservice.attendance_list(page, limit, day, name);
        return date;
